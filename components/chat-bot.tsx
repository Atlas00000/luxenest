      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 md:right-8 z-50 w-full max-w-sm bg-background rounded-xl shadow-xl border overflow-hidden chat-widget theme-transition"
          >
